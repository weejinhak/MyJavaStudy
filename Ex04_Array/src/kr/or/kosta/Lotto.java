...
//5  추가 조건 (홀수만 , 짝수만 , 내가 선택한 번호는 무조건)
//위에서 만드시 내용을 class 설계하세요
//member field , Constructor , method (기능) , 메뉴 
...
//추출
public static void selectBasicNumber(java.util.Random r ,int[] numbers)
{
...
//범위값 체크
public static boolean checkAverage(int[] numbers)
{
	int sum;
	int average;
	sum =0;
...
//메뉴 구성
public static String showMenu(java.util.Scanner scanner)
{
	System.out.println("******************************");
	System.out.println("1. 당첨 예상 번호 추출 : ");
	System.out.println("2. 종료.^^");
